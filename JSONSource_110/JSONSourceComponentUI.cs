...
namespace com.webkingsoft.JSONSource_110
{
    ...
    public class JSONSourceComponentUI : IDtsComponentUI
    {
        ...
        public bool Edit(System.Windows.Forms.IWin32Window parentWindow, Variables vars, Connections cons)
        {
            ...
            {
                _md.CustomPropertyCollection[com.webkingsoft.JSONSource_110.JSONSourceComponent.PROPERTY_KEY_MODEL].Value = _model.ToXmlString();
        ...
        public void Initialize(IDTSComponentMetaData100 dtsComponentMetadata, IServiceProvider serviceProvider)
        {
            ...
            IDTSCustomProperty100 model = _md.CustomPropertyCollection[com.webkingsoft.JSONSource_110.JSONSourceComponent.PROPERTY_KEY_MODEL];
            if (model.Value == null)
            {
                _model = new Model();
